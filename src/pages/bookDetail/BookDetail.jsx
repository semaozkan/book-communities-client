      ...
      <div className={styles.bookInfo}>
        ...
        <div className={styles.infoContainer}>
          <div className={styles.title}>
            ...
            <ul>
              <li>
                Yazan <span>Antoine de Saint-Exupéry</span>
              </li>
              <li>
                Yayınevi <span>Can Yayınları</span>
              </li>
            </ul>
          </div>
          ...
          <div className={styles.content}>
            <p>
              "Hoşça git," dedi tilki. "Vereceğim sır çok basit: İnsan ancak
              yüreğiyle baktığı zaman doğruyu görebilir. Gerçeğin mayası gözle
              görülmez." Küçük Prens unutmamak için tekrarladı: "Gerçeğin mayası
              gözle görülmez."
            </p>
            <p>
            ...
            <p>Çeviren: Tomris Uyar, Cemal Süreya</p>
          </div>
        </div>
      </div>
